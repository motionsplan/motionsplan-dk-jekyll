...
describe('SkinfoldDurnin', function() {
  describe('getBodyPercentFat()', function() {
    it('should return the correct number', function() {
      ...
      let hr = motionsplan.SkinfoldDurnin(10, 10, 20, 20, 80, "male");
  ...
  describe('getBodyPercentFat()', function() {
    it('should return the correct number', function() {
      ...
      // biceps, triceps, hoftekam, skulder, weight, gender, age
      let hr = motionsplan.SkinfoldDurnin(10, 10, 20, 20, 80, "female");
  ...
  describe('getBodyPercentFat()', function() {
    it('should return the correct number', function() {
      let hr = motionsplan.SkinfoldDurnin(10, 10, 20, 20, 80, "female", 60);
  ...
  describe('getDensity()', function() {
    it('should return the correct number', function() {
      ...
      let hr = motionsplan.SkinfoldDurnin(18, 20, 22, 32, 89, "female", 30);
