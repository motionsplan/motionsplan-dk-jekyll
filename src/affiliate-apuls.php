...
// Wallsticker
$xml = 'https://www.partner-ads.com/dk/feed_udlaes2.php?partnerid=28187&bannerid=46187&feedid=637';
$search = 'greb';
$category = 'træningsudstyr';
...
foreach($xmldata->children() as $p) {        
    ...
    if (strpos(strtolower($p->kategorinavn), $category) === false) {
        continue;
    }
