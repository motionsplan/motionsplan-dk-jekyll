...
export const HEART_RATE_MODELS = {
  ...
  joe_friel_7zone: {
    ...
    zones: [
      ...
      { name: 'Zone 5b - Super-Tærskel (VO2max)', minPct: 102, maxPct: 106, useLTHR: true, rpe: 'RPE 9', rpeDesc: 'Hårdt interval', color: '#ef4444', bgColor: '#fef2f2', borderColor: '#fecaca', textColor: '#991b1b', desc: 'Intervaller over tærskel for iltoptagelse.', extendedDetails: 'Intensiv intervaltræning (fx 3–5 minutter) over din bæredygtige tærskel.' },
  ...
  joe_friel: {
    ...
    zones: [
      ...
      { name: 'Zone 5 - Super Tærskel / VO2max', minPct: 102, maxPct: 106, useLTHR: true, rpe: 'RPE 9–10', rpeDesc: 'Over tærskel', color: '#ef4444', bgColor: '#fef2f2', borderColor: '#fecaca', textColor: '#991b1b', desc: 'Lidt over tærskel, kortere intervaller.', extendedDetails: 'Intensiv intervaltræning (fx 3-5 minutter) over din bæredygtige tærskel.' }
    ]
  },
