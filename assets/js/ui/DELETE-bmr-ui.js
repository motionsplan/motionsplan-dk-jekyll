...
export function initCalculator(container) {
  ...
  // Skjul / vis MET-værdier (Event delegation med e.preventDefault())
  container.addEventListener('click', (e) => {
    const toggleBtn = e.target.closest('#bmr-adv-toggle-met');
    if (toggleBtn) {
      e.preventDefault();
      ...
      if (activitySection) {
        ...
        toggleBtn.textContent = isShowing ? '🙈 Skjul MET-værdier' : '⚙️ Tilpas MET-værdier';
      }
    }
  });
