...
description: Madcow 5×5 er et styrketræningsprogram for øvede, der bygger på lineær progression, periodisering og fokus på
  squat, bænkpres og dødløft.
excerpt: Madcow 5×5 er et styrketræningsprogram for øvede, der bygger på lineær progression, periodisering og fokus på squat,
  bænkpres og dødløft.
permalink: /madcow-5x5/
language: da
header:
  teaser: /assets/images/unsplash/photo-1520948013839-62020f374478.jpg
  caption: Madcow 5×5 – Programmet for øvede løftere
categories:
- Styrketræning
...
programs:
  - id: "madcow-5x5"
    title: "Madcow 5x5 Styrketræningsprogram"
    description: "Videreudvikling af Bill Starrs 5x5 med Heavy-Light-Medium struktur, ramped sets og ugentlig lineær progression for øvede."
    
    # TAXONOMI & KATEGORISERING
    category: ["Styrketræning", "Styrketræningsprogrammer"]
    type: ["Lineær progression", "Fullbody", "Heavy-Light-Medium", "5x5"]
    modality: ["Styrketræning"]
    level: ["Let øvet", "Øvet"]
    
    # STRUKTUR & RAMMER
    duration: "8–12 uger (cyklus)"
    frequency: "3 dage/uge"
    split_type: "Fullbody (Heavy / Light / Medium)"
    goal: ["Maksimalstyrke", "Muskelmasse", "Bryde styrkeplateauer"]
    
    # UDSTYR OG PRAKTIK
    equipment: ["Vægtstang", "Squat rack", "Bænk"]
    target_group: ["Øvede løftere", "Mænd", "Kvinder"]
    
    # LINKS OG RELATIONER
    anchor: "#overblik-over-programmet"
    related_tests:
      - "1rm-test"
    related_tools:
      - "1rm-beregner"
...
Programmet er en videreudvikling af [Bill Starrs originale 5×5-program](/bill-starr-5x5/) og blev populariseret af en anonym bruger ved navn “[Madcow](https://web.archive.org/web/20160617121043/http://www.elitefitness.com/forum/members/Madcow2.html)” i begyndelsen af 2000’erne.

{% include figure image_path="/assets/images/stronglifts.com/bill-starr-5x5-workout-236a06dc.webp" caption="Bill Starr dødløfter omkring 302 kg i 1968. Han har lavet det oprindelige 5x5 program, som Madcow er baseret på. [📷](https://stronglifts.com/wp-content/uploads/bill-starr-5x5-workout.webp){: rel='nofollow noopener' }" %}
...
{% include figure image_path="/assets/images/stronglifts.com/madcow-5x5-hlm-0ce1cd17.webp" caption="Fordelingen af de enkelte træninger på en uge. Kilde: [Stronglifts.com](https://stronglifts.com/madcow-5x5/workout-guide/) [📷](https://stronglifts.com/wp-content/uploads/madcow-5x5-hlm.webp){: rel='nofollow noopener' }" %}
...
{% include figure image_path="/assets/images/stronglifts.com/madcow-5x5-heavy-light-medium-hlm-c5643999.webp" caption="Kilde: [Stronglifts.com](https://stronglifts.com/madcow-5x5/workout-guide/) [📷](https://stronglifts.com/wp-content/uploads/madcow-5x5-heavy-light-medium-hlm.webp){: rel='nofollow noopener' }" %}
...
- [StrongLifts Madcow Guide](https://stronglifts.com/madcow-5x5/workout-guide/)
