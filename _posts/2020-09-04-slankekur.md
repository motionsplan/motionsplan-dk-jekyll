---
last_modified_at: '2026-08-13T10:00:00.000Z'
toc: true
permalink: /slankekur/
title: "Effektiv slankekur: Hvad virker egentlig? (Og myten om lynkuren)"
seo_title: "Effektiv slankekur: Hvad virker – og hvorfor dumper lynkure?"
excerpt: "Søger du en slankekur der reelt virker? Lær sandheden om vægttab, hvorfor ugeblades lynkure smider væske frem for fedt, og hvordan du opnår varige resultater."
description: "Den ultimative guide til en effektiv slankekur. Lær om kalorieunderskud, Sense-princippet, NEAT (hverdagsbevægelse) og hvorfor lynkure slår fejl."
language: da
header:
...
Men hvad er en slankekur egentlig? Og hvorfor ender langt de fleste hurtige slankekure med, at kiloene ryger direkte på igen – ofte med renter?

I denne guide kigger vi fysiologisk på, hvad der skal til for at skabe et reelt og varigt [vægttab](/vaegttab/). Vi tager et kig på ugebladenes urealistiske lynkure, ser nærmere på geniale koncepter som **Sense**, og forklarer, hvorfor din **hverdagsbevægelse (NEAT)** er en overset nøgle til succes.

---

## 1. Kan man tabe sig på en slankekur og en kostplan?

Der er ingen tvivl om, at man kan tabe sig med kostplaner og slankekure.

Men lad os kigge på, hvad vi snakker om i de helt utrolige eksempler fra forskelligartede, kortvarige slankekure.
...
At tabe sig handler primært om kalorieunderskud. Altså forskellen mellem, hvad du forbruger, og dit indtag af energi på en dag – dit [ligevægtsindtag](/ligevaegtsindtag-beregner/). 

Hvis du spiser flere [kalorier](/hvad-er-kalorier/), end du bruger, tager du på. Spiser du mindre energi, end du bruger, taber du dig. Vanskeligere er det fysiologisk set ikke.

---

## 2. Myten om "Lynkuren": Hvorfor ugebladenes vægttab snyder
...
Vicky havde allerede tabt sig en del, så hun troede ikke, at *Lynkuren* ville have en ekstra effekt. Men hun formåede altså at tabe sig 4,4 kg på fem dage, så hun endte med at veje 70,25 kg. Vicky vurderer, at det har været let at følge *Lynkuren*, og hun har fået endnu mere blod på tanden.
...
* **Maria** har haft et vægttab på [5 kg på fem dage med kødbolle-slankekuren](https://www.udeoghjemme.dk/slank-og-sund/slank/hurtigt-vaegttab-maria-tabte-5-kilo-paa-fem-dage).
* **Sandra** har været på [rugbrødskuren og tabte 3 kilo](https://www.udeoghjemme.dk/slank-og-sund/slank/slankekure/slankekur-jeg-har-faaet-motivationen-tilbage).

{% include motionsplan/pinterest image_path=page.header.overlay_image data-pin-media="/assets/images/i.pinimg.com/55f6d6bda3f84dbc66eacaf492045cbd-7d67953c.jpg" data-pin-id="579768152025035959" caption=page.title %}

### Beregn nødvendigt energiunderskud for fedttab på slankekur
Beregneren herunder til det nødvendige energiunderskud for fedttab er baseret på, at der i 1 kg fedt er 38.000 kJ eller 9.000 kcal:

{% include calculator/calculator-weightloss-calories.html %}

### Eksempel på energiunderskud fra slankekuren
Hvis vi tager Vicky som eksempel og taster tallene ind i beregneren: Hun skulle altså have et dagligt energiunderskud på **7.920 kcal** for at tabe 0,880 kg fedt om dagen på sin slankekur.

For at sætte det i perspektiv kan vi lige prøve at udregne Vickys [daglige energiforbrug i vores stofskifteberegner](/ligevaegtsindtag-beregner/).

Jeg har været flink, så derfor har jeg brugt hendes nye vægt (70,25 kg) til at udregne energiforbruget. Der står i artiklen, at hun ikke i øjeblikket tager i fitnesscenteret, så jeg har taget udgangspunkt i et almindeligt aktivitetsniveau.

Vickys daglige energiforbrug er formentlig omkring 2.650 kcal. Det viser, hvor vanvittige resultater slankekuren fra Ude og Hjemme har givet. Vickys resultat har altså teoretisk set krævet, at hun har et energiunderskud på **over dobbelt så meget som hendes samlede daglige energiforbrug**.

Det kan jo ikke lade sig gøre!

---

## 3. Hvorfor virker slankekuren så godt?

Der er en lille faktaboks i bladet, hvor jeg tror, at man får det meste af forklaringen på de helt fantastiske resultater fra slankekuren:

> *"Test en kur for Ude og Hjemme – og tjen 1.000 kroner pr. tabt kilo!"*

Se, det forklarer jo mange resultater i mange slankekure. Jeg ville fx gribe denne slankekur an på denne måde:

1. **Først ville jeg drikke tre liter vand**, inden jeg gik på vægten første gang.
2. **Så ville jeg sørge for at undgå kulhydrater i fem dage.** På den måde slipper jeg for at have fyldte kulhydratlagre, som for Vicky formentlig kan være omkring 300–400 gram, som samtidig binder omkring 2–3 gram vand pr. gram.
3. **Så ville jeg på den sidste dag sørge for at spise meget små portioner**, så jeg ikke har mad i maven eller tarmene, når jeg skal vejes igen.
4. **Og jeg ville naturligvis sørge for, at jeg er dehydreret.**

På den måde havde jeg maksimeret, hvad jeg kan tjene på at teste slankekuren for Ude og Hjemme – helt uden at have tabt ret meget fedt!

---

## 4. Hvordan kan en slankekur være effektiv på lang sigt?

Kortvarige slankekure kommer aldrig til at virke. Faktisk er det usundt at have en vægt, der går op og ned. Årsagen til, at mange hopper på dem, er naturligvis ønsket om hurtigt at [tabe fedt på maven](/tab-fedt-paa-maven/).

Med en slankekur skal du i øvrigt altid huske, at når du har tabt dig, så har du brug for mindre daglig energi. Det er også derfor, at en slankekur meget sjældent virker. Du kan nemlig aldrig gå tilbage til dine gamle spisevaner uden at tage det hele på igen, fordi du med en lavere vægt nu skal bruge mindre energi.

En slankekur handler i sidste ende om dit [ligevægtsindtag](/ligevaegtsindtag-beregner/). Hvis en slankekur skal være effektiv, skal du både tænke på, hvor meget energi du indtager, og hvor meget energi du bruger på en dag.

### 🌟 Hvorfor Sense-kuren er et genialt redskab
Hvis du leder efter en struktur, der reelt virker i en travl hverdag, er **Sense** et af de mest gennemtænkte og pædagogiske koncepter.

I stedet for at veje din mad på en vægt eller tælle hver enkelt kalorie, bruger du dine egne hænder til at dosere dine måltider (kaldet *spisekasser*):
* **1–2 håndfulde grøntsager og frugt** (giver fylde, kostfibre og mæthed).
* **1 håndfuld protein** (kød, fisk, æg, bælgfrugter – bevarer muskelmassen).
* **1 håndfuld stivelse/kulhydrat** (brød, ris, pasta, kartofler).
* **1–3 spiseskefulde fedtstof** (olie, smør, nødder, avocado).

Sense er genialt, fordi det ubevidst skaber et fornuftigt kalorieunderskud og sikrer høj mæthed uden at forbyde bestemte fødevarer. Det lærer dig god portionsanretning for livet.

---

## 5. Den oversete nøgle: NEAT og hverdagsbevægelse

Kosten er langt den væsentligste faktor under et vægttab, men du forbrænder også en del kalorier bare ved at bevæge dig i hverdagen.

I fagsproget kaldes dette for **NEAT** (*Non-Exercise Activity Thermogenesis*). NEAT er al den energi, du forbrænder på aktiviteter, der IKKE er planlagt sport eller styrketræning:
* At du tager trappen frem for elevatoren.
* At du går eller cykler til og fra arbejde.
* At du gør rent, arbejder i haven eller rejser dig op ved skrivebordet.
* At du tager ekstra gåture i løbet af dagen.

Når folk går på for stramme slankekure, falder deres NEAT ofte automatisk, fordi kroppen prøver at spare på energien. Man bliver træt, sætter sig mere ned og forbrænder ubevidst færre kalorier. 
...
## 6. Opsummering: Sådan får du slankekuren til at virke
