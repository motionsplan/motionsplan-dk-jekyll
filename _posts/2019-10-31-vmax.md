...
tests:
  - id: "test-vmax-tmax"
    title: "Vmax og Tmax Test (Smith et al. 1999)"
    description: "Maksimal udmattelsestest til bestemmelse af den minimale hastighed/belastning for VO2max (Vmax) samt udholdenhedstiden ved denne intensitet (Tmax)."
    category: ["Kondition", "Konditionstræning"]
    type: ["Protokol", "Konditionstest"]
    execution: ["Fysisk"]                  # 🏃‍♂️ FYSISK TEST: Kræver maksimal udmattelse ved Vmax
    method: "indirekte"                  # 🧮 Indirekte test: Bestemmelse af hastighed og udholdenhedstid ved VO2max
    modality: ["Løb", "Cykling"]
    measures: ["Vmax", "Tmax", "VO2max", "Udholdenhed"]
    equipment: ["Stopur", "Løbebane", "Løbebånd", "Ergometercykel"]
...
Stuidet er oprindeligt lavet på løb, så det er helt oplagt at integrere ideerne bag træningen i din løbetræning. Du kan enten løbe intervallerne på [løbebånd](/guide-loebebaand/), hvor du kan sætte den nøjagtige hastighed. Du kan også sagtens løbe på 400 meter løbebane eller på en flad rute.
...
Du kan også flytte din maksimale iltoptagelse på andre måder. Billat et al (1999) har lavet en [anden protokol, som jeg har lavet en anden beregner til](/billat-vvovmax-tlimvo2max/), der baserer sig på nogle af de samme parametre.
