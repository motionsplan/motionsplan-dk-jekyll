...
description: "Bill Starrs 5x5 er et simpelt og effektivt styrketræningsprogram med fokus på squat, bænkpres og power cleans. Perfekt til begyndere og let øvede."
...
programs:
  - id: "bill-starr-5x5"
    title: "Bill Starr 5x5 Styrkeprogram"
    description: "Legendarisk 3-dages helkropsprogram med ramped 5x5 sæt, lineær ugentlig progression og fokus på squat, bænk og power clean/rows."
    
    # TAXONOMI & KATEGORISERING
    category: ["Styrketræning", "Styrketræningsprogrammer"]
    type: ["Lineær progression", "Fullbody", "Ramped sets", "5x5"]
    ...
    goal: ["Maksimal grundstyrke", "Atletisk eksplosivitet", "Lineær fremgang"]
    
    # UDSTYR OG PRAKTIK
    equipment: ["Vægtstang", "Squat rack", "Bænk"]
    target_group: ["Begyndere", "Let øvede", "Atleter"]
    
    # LINKS OG RELATIONER
    anchor: "#typisk-ugeplan"
    related_tests:
      - "1rm-test"
    related_tools:
      - "1rm-beregner"
