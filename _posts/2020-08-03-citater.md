...
seo_title: "24 træningscitater om løb, styrketræning og motivation (2023)"
...
{% include pinterest-gallery caption=page.title %}
...
{% include pinterest-gallery id="gallery_running" caption=page.title %}
