...
tests:
  - id: "test-vbt-1rm-estimering"
    ...
    execution: ["Fysisk"]                  # 🏋️‍♂️ FYSISK TEST: Kræver submaksimale løft med vægtstang og hastighedsmåling
    method: "indirekte"                   # 📊 Indirekte estimering af 1RM ud fra hastighedsprofil og Minimal Velocity Threshold (MVT)
