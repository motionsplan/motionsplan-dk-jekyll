...
{% include figure image_path="/assets/images/upload.wikimedia.org/Muscle_Force_Velocity_relationship-86a7aff1.png" caption="Force-velocity og power kurve. Billede: [Wikipedia](https://en.wikipedia.org/wiki/Muscle_contraction). [📷](https://upload.wikimedia.org/wikipedia/en/2/22/Muscle_Force_Velocity_relationship.png){: rel='nofollow noopener' }" %}
