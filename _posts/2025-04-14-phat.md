...
programs:
  - id: "phat-layne-norton"
    title: "Power Hypertrophy Adaptive Training (PHAT)"
    description: "5-dages kombineret styrke- og hypertrofiprogram af Layne Norton, der rammer hver muskelgruppe to gange ugentligt med både tunge løft og høje reps."
    
    # TAXONOMI & KATEGORISERING
    category: ["Styrketræning", "Styrketræningsprogrammer"]
    type: ["Splitprogram", "Styrke & Hypertrofi", "Upper/Lower", "PPL"]
    modality: ["Styrketræning"]
    level: ["Øvet", "Erfaren"]
    
    # STRUKTUR & RAMMER
    duration: "Løbende (Ugentlig cyklus)"
    frequency: "5 dage/uge"
    split_type: "5-split (Upper/Lower Power + PPL Hypertrofi)"
    goal: ["Maksimalstyrke", "Muskelmasse (Hypertrofi)", "Volumentolerans"]
    
    # UDSTYR OG PRAKTIK
    equipment: ["Vægtstang", "Håndvægte", "Kabeltårn", "Squat rack", "Bænk"]
    target_group: ["Bodybuildere", "Styrkeatleter", "Øvede løftere"]
