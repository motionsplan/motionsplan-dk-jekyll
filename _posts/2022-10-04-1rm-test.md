...
description: Lær, hvordan du sikkert og effektivt kan teste din One Rep Max (1RM) med en fysisk maxtest. Få en trin-for-trin
  guide til gennemførelse.
excerpt: Har du også lyst til at vide, hvad du kan løfte i styrketræning? Det kan du bruge en RM-test til. Her dykker vi ned
  i, hvor dan du laver en one rep max test.
language: da
header:
  ...
  caption: Maxtest - test din one rep max (1RM) i styrketræning
  overlay_filter: '0.3'
meta:
...
tests:
  - id: "test-1rm-maxtest"
    title: "1RM Maxtest (One Repetition Maximum)"
    description: "Standardiseret fysisk testprotokol til direkte måling af din maksimale muskelstyrke (1RM) i styrketræningsøvelser med vægtstang under maksimal belastning."
    category: ["Tests", "Styrketræning"]
    type: ["Protokol", "Styrketest"]
    execution: ["Fysisk"]                  # 🏋️‍♂️ FYSISK TEST: Kræver direkte løft af maksimal belastning (1RM)
    method: "direkte"                     # 📊 Måles direkte i kilo (kg) på vægtstangen
    modality: ["Styrketræning"]
    measures: ["Maksimal styrke", "1RM", "One Repetition Maximum", "Maksimal vægt (kg)"]
    equipment: ["Vægtstang", "Vægtskiver", "Squat rack / Bænk", "Safety pins", "Spottere"]
    setting: ["Styrkerum", "Fitnesscenter", "Testcenter", "Individuel"]
    target_group: ["Atleter", "Styrkeløftere", "Motionister", "Mænd", "Kvinder"]
    related_tools: []
categories:
- Tests
- Styrketræning
...
- question: Hvordan finder jeg min egen 1RM?
  answer: Du kan finde din 1RM på flere måder. Den mest præcise metode er at udføre en [1RM-test](/rm-maxtest/), hvor du gradvist
    øger vægten, indtil du når dit maksimale løft. Alternativt kan du bruge vores [1RM-beregner](/rm-beregner/) eller manuelt
    beregne den med en af de mest anvendte [1RM-formler](/1rm-formler/).
- question: Hvad betyder RM, 1RM max og One Repetition Maximum?
  answer: '**One Repetition Maximum (1RM)** er den maksimale vægt, du kan løfte én gang i en given øvelse. RM (Repetition
    ...
    fem gange. Kendskab til 1RM er nyttigt, hvis du følger et procentbaseret træningsprogram.'
---
...
## Overblik: 4 måder at finde din 1RM på

Inden du kaster dig ud i en fysisk maxtest, er det en god idé at overveje, om en af de andre testmetoder passer bedre til dit temperement, udstyr og skadesrisiko:

| Testmetode | Fordele | Ulemper |
| :--- | :--- | :--- |
| **1. Fysisk maxtest** | Det mest præcise resultat af din reelle styrke. | Tidskrævende, kræver spottere/safety pins og har høj skadesrisiko. |
| **2. [RM-beregner](/rm-beregner/)** | Nemt og sikkert med submaksimale løft (fx 5RM). | Kan over/underestimere afhængigt af din rep-range og erfaring. |
| **3. [RPE-test](/rpe/)** | Justerer for dagsform uden at løfte helt til failure. | Kræver god erfaring i at bedømme egen anstrengelse (RIR). |
| **4. [Velocity Based (VBT)](/vbt/)** | Nøjagtig estimering ud fra stangens hastighed. | Kræver specialiseret hardware/sensor-udstyr. |
...
## Før log over dine maxtests i et regneark

Når du gennemfører fysiske maxtests, er det vigtigt at holde styr på din progression over tid. Du kan hente vores færdige Google Sheet, hvor du nemt kan føre log over dine testresultater og estimere nye træningsvægte.
...
Der er både fordele og ulemper ved at max-teste. Hvis du jævnligt vil teste din styrke, så er den smarteste fremgangsmåde nok at bruge nogle af de submaksimale tests. Hvis du har adgang til en kraftplatform, så kan du også få et meget brugt mål for styrke ved en [IMTP-test](/imtp-test/).
