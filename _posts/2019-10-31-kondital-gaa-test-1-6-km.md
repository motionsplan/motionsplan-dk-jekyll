...
description: 'Tag en simpel gå-test og beregn dit kondital med Rockport (1,6 km) eller UKK (2 km). Den ideelle, skånsomme konditionstest for dig, der vil i form.'
...
tests:
  ...
  - id: "test-ukk-2km-gangtest"
    ...
    modality: ["Gang"]
    measures: ["Kondital", "VO2max", "Iltoptagelse"]
    equipment: ["Fladt underlag", "Stopur", "Pulsmåler", "Vægt", "Højdemåler"]
    setting: ["Udendørs", "Løbebane", "Individuel"]
...
tools:
  - id: "tool-rockport-gangtest-beregner"
    title: "Gå-test Beregner (Rockport 1,6 km & UKK 2,0 km)"
    description: "Beregn dit kondital (VO2max) ud fra gangtid og slutpuls på 1,6 km (Rockport) eller 2,0 km (UKK gå-test)."
    category: ["Kondition"]
    type: ["Beregner"]
...
- featured
- populær
last_modified_at: '2026-08-29T22:15:00Z'
faq:
  ...
  - question: Hvad er forskellen på Rockport og UKK gå-testen?
    answer: Rockport-testen foregår over 1,6 km (1 mile) og kræver køn, alder, vægt, tid og puls. UKK-testen er på 2,0 km og inddrager også din højde til beregning af BMI, hvilket korrigerer for kropsbygning.
...
Rockports gå-test er skånsom for led og sener og henvender sig især til begyndere, utrænede, overvægtige og ældre. Alt det kræver er, at du kan gå 1,6 kilometer i et rask tempo, måle tiden og aflæse din puls til sidst. Foretrækker du en lidt længere rute, indeholder vores beregner også den klassiske nordiske **UKK 2,0 km gå-test**.
...
I beregneren længere nede kan du indtaste dine resultater og udregne dit kondital. Du har endda mulighed for at skifte til den nordiske UKK 2,0 km gå-test i toppen af værktøjet.
...
**Følg disse 5 trin for at gennemføre testen:**

1. **Vælg test & mål dig:** Beslut om du vil gå Rockport (1,6 km – anbefalet) eller UKK (2,0 km). Vej dig i kg (og mål din højde i cm, hvis du vælger UKK).
2. **Mål distancen:** Find 1.609 m (Rockport, ca. 4 runder på 400 m bane) eller 2.000 m (UKK, 5 runder) på en atletikbane eller en flad GPS-opmålt vej. Testen kan laves på løbebånd, men udendørs gang giver det mest præcise resultat. 
3. **Varm op:** Gå i et roligt tempo i 5–10 minutter, så kroppen er klar.
4. **Gå testen & mål pulsen:** Gå distancen så hurtigt du kan uden at løbe. Stop uret ved målstregen og aflæs straks din puls eller tæl den i 15 sekunder og gang med 4.
5. **Brug beregneren:** Vælg testen i beregneren herunder, indtast dine data og se dit kondital med det samme.

## Udregn dit kondital med gå-testen
{: id="calculator" }

Indtast din tid, slutpuls og dine personlige data i beregneren herunder. Vælg mellem **Rockport 1,6 km** og **UKK 2,0 km** i toppen af beregneren.
...
I beregneren anvender vi to anerkendte fysiologiske modeller til Rockport-testen, afhængigt af din alder og grundform:
...
## UKK 2,0 km gå-test: Det nordiske alternativ

Selvom Rockport (1,6 km) er den globale standard, har vi i Norden en stolt tradition for **UKK 2,0 km gå-testen** (udviklet af det finske *Urho Kaleva Kekkonen Institute*). 

UKK-testen er bygget op om de samme submaksimal-principper som Rockport, men adskiller sig ved at være 400 meter længere og inddrage din højde (BMI) i beregningen.

### Formlen bag UKK 2 km gå-testen (Oja et al., 1991)

UKK-testen udregner dit kondital ved at kombinere gangtid, slutpuls, alder og BMI:

**Formel for mænd:**
$$ \text{Kondital} = 184{,}9 - (4{,}65 \cdot \text{Tid}) - (0{,}22 \cdot \text{Puls}) - (0{,}26 \cdot \text{Alder}) - (1{,}05 \cdot \text{BMI}) $$

**Formel for kvinder:**
$$ \text{Kondital} = 116{,}2 - (2{,}98 \cdot \text{Tid}) - (0{,}11 \cdot \text{Puls}) - (0{,}14 \cdot \text{Alder}) - (0{,}39 \cdot \text{BMI}) $$

*Hvor:*
* **Tid:** Den samlede gangtid i minutter med decimaler.
* **Puls:** Slutpuls målt umiddelbart efter 2,0 km.
* **BMI:** Kropsvægt i kg divideret med højden i meter i anden ($\text{kg}/\text{m}^2$).

## Rockport 1,6 km vs. UKK 2,0 km: Hvad er forskellen?

| Parameter | Rockport Walk Test (Førstevalg) | UKK 2 km Gå-test |
| :--- | :--- | :--- |
| **Distance** | 1.609 meter (1 mile / 4 runder) | 2.000 meter (5 runder) |
| **Målevariabler** | Tid, slutpuls, vægt, alder, køn | Tid, slutpuls, vægt, højde (BMI), alder, køn |
| **Oprindelse** | USA (Kline et al., 1987) | Finland (Oja et al., 1991) |
| **Aldersgruppe** | 18–69+ år | 20–65 år |
| **Anvendelse** | Global standard i fitness og fysiologi | Klassisk test i nordisk sundhedsfremme |
...
- Laukkanen, Raija, Pekka Oja, M. Pasanen, og Ilkka Vuori. 1992. "Validity of a two-kilometre walking test for estimating maximal aerobic power in overweight adults". *International Journal of Obesity and Related Metabolic Disorders* 16 (4): 263–68.
- Oja, Pekka, Raija Laukkanen, M. Pasanen, Tytti Tyry, og Ilkka Vuori. 1991. "A 2-km walking test for assessing the aerobic fitness of healthy adults". *International Journal of Sports Medicine* 12 (4): 356–62. <https://doi.org/10.1055/s-2007-1024694>.
- Greiwe, Jeffrey S., et al. 1995. "Evaluation of the Rockport Fitness Walking Test on a Treadmill in Young and Older Adults". *Research Quarterly for Exercise and Sport* 66 (3): 248–53.
</details>