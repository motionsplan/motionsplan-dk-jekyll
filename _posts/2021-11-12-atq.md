...
tests:
  - id: "test-atq-negative-tanker"
    title: "Automatic Thoughts Questionnaire (ATQ-30)"
    description: "Valideret psykometrisk screeningværktøj (Hollon & Kendall, 1980 / Mia Lichtenstein, 2019) til opgørelse af hyppigheden af og overbevisningen om automatiske negative tanker på tværs af 4 faglige underkategorier."
    category: ["Psykologi", "Vurderingsværktøjer"]
    type: ["Protokol", "Screening"]
    execution: ["Spørgeskema"]            # 📋 SPØRGESKEMA / PSYKOMETRISK TEST
    method: "spørgeskema"
    modality: ["Psykologi"]
    measures: ["Automatiske negative tanker", "ATQ-score", "Frekvensscore", "Tro-score", "PMDC", "NSNE", "LSE", "Helplessness"]
    equipment: ["Ingen"]
...
tools:
  - id: "tool-atq-beregner"
    ...
    description: "Interaktivt spørgeskema til udregning af din samlede ATQ-score for hyppighed og overbevisning af negative tanker."
    category: ["Psykologi", "Vurderingsværktøjer"]
    type: ["Beregner"]
    measures: ["ATQ-score", "Automatiske negative tanker", "Frekvensscore", "Tro-score"]  # 🎯 Output-parametre fra spørgeskemaet
...
Du kan prøve spørgeskemaet ovenfor, som er udviklet til forskning og til at måle effekten af behandling. Du kan ikke bruge testen til at teste om du er deprimeret. Det kan du i stedet prøve [trivselstesten](/who5-trivselindekset/) eller denne [test for depression](/phq-9-depression-test/).
