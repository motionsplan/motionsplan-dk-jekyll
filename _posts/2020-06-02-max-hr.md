...
seo_title: "Max puls - Hvordan finder du din maxpuls [Beregner]"
...
Jeg har brug for at vide, hvad min max puls er. Jeg har undersøgt, hvordan jeg kan finde ud af, hvad min maksimale puls er med en beregning ud fra min alder eller fysisk test? Jeg har også kigget på, hvad der begrænser maxpulsen?
...
Du kan derfor lave en beregning af din maxpuls ud fra din alder, men der er relativt stor individuel afvigelse. Derfor er det nok bedste at måle din maksimale puls direkte selv med en test, så du får det mest præcise tal.
