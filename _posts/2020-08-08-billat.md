...
header:
  overlay_image: /assets/images/unsplash/photo-1517895223695-f378b0bebe28.jpg
  credit: https://images.unsplash.com/photo-1517895223695-f378b0bebe28
  teaser: /assets/images/unsplash/photo-1517895223695-f378b0bebe28.jpg
  caption: 'Billat: Træn efter vVOvmax og tlimvVO2max og løb hurtigere'
last_modified_at: '2026-07-24T09:41:09.000Z'
language: da
categories:
- Løb
- Løbetests
...
meta:
  ...
  intensity: "maksimal"
tests:
  - id: "test-billat-6min-vvo2max"
    title: "Billat 6-Minutters Test (vVO2max Test)"
    description: "Maksimal 6-minutters løbetest til indirekte at bestemme din minimale løbehastighed ved VO2max (vVO2max) og planlægge specifikke VO2max-intervaller."
    category: ["Tests", "Kondition", "Løb"]
    type: ["Protokol", "Konditionstest"]
    execution: ["Fysisk"]                  # 🏃‍♂️ FYSISK TEST: Kræver maksimal 6-minutters løbeindsats
    method: "indirekte"                   # ⏱️ Indirekte estimering af vVO2max ud fra tilbagelagt distance på 6 minutter
    modality: ["Løb"]
    measures: ["vVO2max", "Løbehastighed", "Kondital", "tlimvVO2max"]
    equipment: ["Løbebane", "GPS-ur", "Stopur"]
    setting: ["Udendørs", "Løbebane", "Individuel", "Holdtest"]
    target_group: ["Motionister", "Atleter", "Unge", "Voksne", "Mænd", "Kvinder"]
    related_tools:
      - "tool-billat-vvo2max-beregner"

# INTERAKTIVE SOFTWARE-VÆRKTØJER
tools:
  - id: "tool-billat-vvo2max-beregner"
    title: "Billat vVO2max & Interval Beregner"
    description: "Beregn din minimale løbehastighed ved VO2max (vVO2max) ud fra din 6-minutters test og få præcise distancer til 30-30, 60-60 og 3-3 intervaller."
    category: ["Løb"]
    type: ["Beregner"]
    measures: ["vVO2max", "Intervalhastighed", "Intervaldistance", "Pace"]  # 🎯 Output-parametre fra modulet
    anchor: "#calculator"
    category_schema: "HealthAndFitnessApplication"
programs:
  - id: "billat-vvovmax-intervalprogram"
    title: "Billat vVO2max Intervalprogram (4 uger)"
    description: "Videnskabeligt underbygget 4-ugers intervalprogram med 30-30, 60-60 og 3-3 sessioner til at øge vVO2max og løbeøkonomi."
    
    # TAXONOMI & KATEGORISERING
    category: ["Løb", "Løbeprogrammer"]
    type: ["Intervaltræning", "VO2max", "vVO2max"]
    modality: ["Løb"]
    level: ["Let øvet", "Øvet"]
    
    # STRUKTUR & RAMMER
    duration: "4 uger"
    frequency: "3 sessioner/uge (2 intervaller + 1 tærskel/rolig)"
    split_type: "Intervaller & Tærskel"
    goal: ["Øge vVO2max", "Forbedre løbeøkonomi", "Højere iltoptagelse"]
    
    # UDSTYR OG PRAKTIK
    equipment: ["Løbebane / GPS-ur", "Stopur", "Løbesko"]
    target_group: ["Motionister", "Konkurrenceløbere", "Atleter"]
    
    # LINKS OG RELATIONER
    anchor: "#hvordan-skal-du-traene"
    related_tests:
      - "test-billat-6min-vvo2max"
      - "cooper-test"
    related_tools:
      - "tool-billat-vvo2max-beregner"
      - "hastigheds-beregner"
---
Denne løbeberegner er baseret på Billat et al (1999), som har vist at løbetræning i 4 uger kan forbedre den anaerobe tærskel, den [maksimale iltoptagelse](/maksimale-iltoptagelse-vo2max/) og løbeøkonomien. Løbsberegneren introducerer to vVO₂max og tlimvVO₂max som centrale træningsparametre, så dem beskriver jeg først.
...
> 💡 **Synes du en 6-minutters all-out test er for hård?**  
> Du kan også finde din $vVO_2max$ med en [submaksimal 6-minutters løbetest (Olher et al.)](/submaximal-6min-vvo2max-test/), hvor du kun løber med moderat puls.
{: .notice--info }
...
Når man løber omkring vVO₂max, så får man neuromusklære tilpasninger, som kan være med til at reducere energiforbruget ved løb. Jeg har skrevet et andet indlæg om [tilpasninger ved konditionstræning](/tilpasning-konditionstraening/).
...
Løbetræningsprogrammet fra Billat et al (1999) er relativt enkelt at gå til. Hvis du har brug for at kende din hastighed på den anaerobe tærskel, så kan du løbe en [hurtig 5 kilometer](/artikel/det-mest-effektive-loebeprogram-til-forbedre-din-praestation/).

Husk at intervallerne til at forbedre vVO₂max i Billats løbeprogram kun bliver løbet en gang om ugen, mens der en anden gang om ugen bliver arbejdet på hastigheden ved den anaerobe tærskel. De andre gange i træningen er træningen med lavere intensitet. Du kan læse lidt mere om forskellige [træningsformer til løbeprogrammer](/guide-til-loebeprogram/).

Hvis du gerne vil læse mere om løb, så tjek [Løbesiden](/loebesiden/).
