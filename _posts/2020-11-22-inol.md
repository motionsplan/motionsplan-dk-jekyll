...
language: da
header:
  overlay_image: /assets/images/unsplash/photo-1533560777802-046814bc297c.jpg
  credit: https://images.unsplash.com/photo-1533560777802-046814bc297c
  teaser: /assets/images/unsplash/photo-1533560777802-046814bc297c.jpg
  caption: 'INOL: Hold styr på volumen og intensiteten i din styrketræning'
categories:
- Styrketræning
tags:
- beregner
...
meta:
  ...
  type: styrketræning
tools:
  - id: "tool-inol-beregner"
    title: "INOL Belastningsberegner"
    description: "Interaktiv beregner til udregning af INOL-værdi for enkeltøvelser og samlede træningsuger baseret på antal løft og % af 1RM."
    category: ["Styrketræning"]
    type: ["Beregner"]
    measures: ["INOL", "Træningsbelastning", "Intensitet", "Volumen"]
    anchor: "#calculator"
    category_schema: "HealthAndFitnessApplication"

  - id: "tool-inol-reverse-beregner"
    title: "INOL Gentagelsesberegner"
    description: "Beregn det anbefalede antal gentagelser ved en specifik intensitet (%1RM) ud fra din ønskede målsætning for INOL-belastning."
    category: ["Styrketræning"]
    type: ["Beregner"]
    measures: ["Gentagelser", "Intensitet", "Mål-INOL"]
    anchor: "#hvor-mange-gentagelser-skal-jeg-tage-i-min-traening"
    category_schema: "HealthAndFitnessApplication"
...
Når du har besluttet dig for, hvilken intensitet i forhold til din [one rep max](/rm-beregner/), så kan du bruge denne beregner til at finde antallet af gentagelser.
