...
* **Hos en utrænet person:** Hjertets slagvolumen i hvile er relativt lille (f.eks. $70 \text{ mL/slag}$). For at nå $5 \text{ L/min}$ skal hjertet slå ca. **71 gange i minuttet** ($0{,}070 \text{ L} \times 71 \text{ BPM} \approx 5{,}0 \text{ L/min}$).
* **Hos en veltrænede atlet:** Konditionstræning gør hjertets venstre hjertekammer større og stærkere, så slagvolumen i hvile stiger markant (f.eks. til $120 \text{ mL/slag}$). Hjertet behøver nu kun slå **41 gange i minuttet** for at pumpe den samme mængde blod rundt ($0{,}120 \text{ L} \times 41 \text{ BPM} \approx 5{,}0 \text{ L/min}$). Det er grunden til, at veltrænede får en meget lav hvilepuls!
