...
{% include motionsplan/exercise-grid.html title="Øvelser til foamrolling med foamroller" exercises=exercises %}

{% assign equipment = "lacrosse bold" %}
{% assign exercises = site.exercises | where: "equipment", equipment | sort: "title" %}
{% include motionsplan/exercise-grid.html title="Øvelser med Lacrosse bolde" exercises=exercises %}
