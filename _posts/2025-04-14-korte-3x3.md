...
header:
  ...
  credit: https://repone.de/wp-content/uploads/2022/09/IMG_7341-1.jpg
  caption: *title
category:
  - Styrketræning
...
programs:
  - id: "korte-3x3"
    title: "Korte 3x3 Styrkeløftprogram"
    description: "Klassisk 8-ugers tysk program af Stephan Korte opdelt i en højvolumen fase 1 og en højintensiv fase 2 for squat, bænkpres og dødløft."
    
    # TAXONOMI & KATEGORISERING
    category: ["Styrketræning", "Styrketræningsprogrammer"]
    type: ["Styrkeløft", "Højfrekvent", "Periodiseret"]
    modality: ["Styrketræning"]
    level: ["Øvet", "Erfaren"]
    
    # STRUKTUR & RAMMER
    duration: "8 uger (2 faser)"
    frequency: "3 dage/uge"
    split_type: "Fullbody (Squat, Bænk & Dødløft hver gang)"
    goal: ["Maksimalstyrke i Styrkeløft", "1RM PR", "Teknisk overskud"]
