...
description: Her kan du læse alt om måling af BMI og sammenlign det med et forbedret BMI skema og tabel for mænd og kvinder.
  Forstå alle detaljerne i dag!
permalink: /bmi/
excerpt: Body Mass Index (BMI) er et meget udbredt formel til at teste og måle, om du er sund. Her får du alt at vide om fordele
  og ulemper ved indekset.
language: da
header:
...
- question: Hvad skal kvinders BMI være?
  answer: Voksne kvinder og mænds BMI bliver vurderet efter de samme tabeller. Studier har vist, at et sundt BMI ligger i
    den højere del af 'normalvægt'. Du kan se BMI-skemaer her på siden.
- question: Hvad skal mænds BMI være?
  answer: Voksne mænd og kvinders BMI bliver vurderet efter det samme BMI skema. Nyere studier viser, at et sundt BMI formentlig
    ligger i den højere ende af normalområdet. Du kan se BMI-tabeller her på siden.
- question: Hvad er normal BMI for børn?
  answer: Børn passer ikke ind i den normale BMI skala. WHO har lavet skemaer, hvor du kan vurdere børns BMI. Du kan læse
    mere om [BMI for børn, unge og teenagere](/bmi-beregner-boern-unge-teenagere/), hvor du også kan finde en BMI udregner
    for børn.
- question: Hvad er normal BMI for teenagere?
  answer: Du skal vurdere teenageres BMI ud fra WHOs BMI-skemaer. Men husk at børn og teenagere udvikler sig meget forskelligt.
    Du kan læse mere om [BMI for børn, unge og teenagere](/bmi-beregner-boern-unge-teenagere/).
...
- question: Hvad er din ideelle kropsvægt ifølge BMI-udregningen?
  answer: Du kan udregne din ideelle kropsvægt på baggrund af BMI. Vi har skrevet meget mere om [idealvægt baseret på BMI
    her](/idealvaegt/).
gallery_bmi_child:
...
Leder du efter et retvisende BMI-skema for kvinder og mænd? 
...
Her får du den komplette guide til at forstå dit BMI. Du kan teste dit eget tal længere nede på siden, sammenligne det med de officielle tabeller, og blive klogere på, hvorfor det "normale" BMI måske i virkeligheden trænger til en opdatering.

Jeg har i dette indlæg forsøgt at svare på følgende spørgsmål:

- Hvad er BMI (Body Mass Index)?
- Hvordan udregner man BMI? Hvilken formel bruges til udregning af BMI?
...
- Hvilke fordele og ulemper er der ved BMI-tabeller?

## Test dig selv: Udregn dit BMI-tal her

I denne test kan du let udregne dit BMI-tal uden at skulle have din lommeregner frem.
...
{% include figure image_path="/assets/images/helsebladet.dk/BMI-diagrammer-med-infografik-til-maend-og-kvinder-beregn-bmi-helsebladet-af0dea91.jpg" caption="Hvad er din BMI i forhold til normale BMI for mænd, kvinder, børn og voksne? Kilde: [helsebladet.dk](https://helsebladet.dk/bmi-beregner/) [📷](https://helsebladet.dk/wp-content/uploads/2025/02/BMI-diagrammer-med-infografik-til-maend-og-kvinder-beregn-bmi-helsebladet.jpg){: rel='nofollow noopener' }" alt="Tabel med skala for normal BMI for mænd, kvinder, børn og voksne" %}
