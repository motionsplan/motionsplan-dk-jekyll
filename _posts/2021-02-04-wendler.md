...
language: da
header:
  overlay_image: https://images.unsplash.com/photo-1574680178050-55c6a6a96e0a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1900&q=80
  teaser: https://images.unsplash.com/photo-1574680178050-55c6a6a96e0a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=400&q=80
  caption: *title
category:
  - Styrketræning
tags:
...
Jim Wendlers udviklede oprindeligt 5-3-1 program i 2008, og grundprincipperne er stadig de samme, selvom Jim Windler har lavet mange _tweaks_ og variationer af programmet, så det kan bruges i forhold til forskellige mål med din styrketræning. Jim Wendlers program er et [upper/lower 2-split program]({% link _posts/2021-08-16-styrke-2-split-upper-lower.md %}) som kan tilpasse de fleste mål, men udgangspunkt er, at du træner **4 gange om ugen**.
...
{% include video provider="youtube" id="qgJbOLWSmOo" %}
...
Wendlers 5/3/1 er egentlig simpelt. Du skal starte forholdsvis let, og så sætter du gradvist flere kilo på stangen.
...
Du skal aldrig øge dit træningsmax med mere end 2,5 kilo for overkropsøvelserne og 5 kg for underkropsøvelserne.
