...
description: Vil du gerne i gang med Jim Wendlers 5-3-1 program? her har du en komplet guide til det meget effektive Wendler
  5-3-1 styrketræningsprogram.
excerpt: Få overblik over Jim Wendlers 5/3/1-program – et simpelt, effektivt styrketræningsprogram med fokus på progression
  i basisløft og maksimal styrke.
language: da
header:
  ...
  caption: Wendler 5-3-1 program til styrketræning og maksimal styrke
categories:
- Styrketræning
...
meta:
  ...
  goal: generelt
programs:
  - id: "wendler-531-styrkeprogram"
    title: "Wendler 5/3/1 Styrkeprogram"
    description: "Klassisk 4-ugers cyklisk splitprogram opbygget omkring 4 store basisløft med procentbaseret lineær og undulating progression."
    
    # TAXONOMI & KATEGORISERING
    category: ["Styrketræning", "Styrketræningsprogrammer"]
    type: ["Splitprogram", "Procentbaseret", "Periodiseret"]
    ...
    goal: ["Maksimalstyrke i 4 basisløft", "Muskelmasse", "Langsigtede PRs"]
    
    # UDSTYR OG PRAKTIK
    equipment: ["Vægtstang", "Squat rack", "Bænk"]
    target_group: ["Øvede løftere", "Styrkeatleter", "Mænd", "Kvinder"]
    
    # LINKS OG RELATIONER
    anchor: "#hvad-er-wendlers-5-3-1-program"
    related_tests:
      - "1rm-test"
    related_tools:
      - "1rm-beregner"
...
Programmet er relativt simpelt og nemt at tilpasse, men det er ikke sikkert, det passer til alle. Du kan finde inspiration i andre [styrketræningsprogrammer](/styrketraeningsprogrammer/), hvis du ønsker alternativer.
...
Du skal først [teste din 1RM-max](/pap-post-activation-potentiation-1rm-maxtest/). Du kan fx bruge vores [RM beregner](/rm-beregner/), hvor du kan udregne din 1RM ud fra 3RM, 4RM eller 5RM.
...
Jim Wendler står bag en del mindeværdige [citater om styrketræning og træning](/citater-traening-motivation/) i det hele taget. Jeg har lavet et par enkelte Pinterest-billeder her:
