...
Du kan lave [pulstræning](/pulstraening/), hvor du kan træne med forskellige [pulszoner](/pulstraening-pulszoner-fra-maxpuls-og-pulsreserve/). Pulszonerne er ofte etableret udfra [maxpulsen](/test-max-puls/), men du kan også bruge pulsreserven, som også inddrager [hvilepuls]({% link _posts/2020-06-03-hvilepuls.md %}).
