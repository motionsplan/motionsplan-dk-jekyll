...
Du kan lave [pulstræning]({% link _posts/2019-10-31-pulstraening.md %}), hvor du kan træne med forskellige [pulszoner]({% link _posts/2019-10-31-hrzones-puls.md %}). Pulszonerne er ofte etableret udfra [maxpulsen](/test-max-puls/), men du kan også bruge pulsreserven, som også inddrager [hvilepuls]({% link _posts/2020-06-03-hvilepuls.md %}).
