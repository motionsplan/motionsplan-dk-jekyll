...
Heart Rate Variability (HRV) er ifølge [Wikipedia](https://en.wikipedia.org/wiki/Heart_rate_variability) forskellen mellem hjerteslagene. HRV er en biomarkør, som man kan måle relativt præcist med en almindeligt pulsbælte og en app på din smartphone. Det ser ud til, at der er en sammenhæng mellem [restitution]({% link _posts/2020-05-28-restitution.md %}) og HRV, og derfor er HRV rigtig interessant ift. optimering af ens egen træning.
