...
[Heart Rate Variability (HRV)](https://en.wikipedia.org/wiki/Heart_rate_variability) er altså forskellen mellem hjerteslagene. HRV er en biomarkør, som man kan måle relativt præcist med en relativt almindeligt pulsbælte og en app på din smartphone. Det ser ud til, at der er en sammenhæng mellem [restitution]({% link _posts/2020-05-28-restitutionstid-alder.md %}) og HRV, og derfor er HRV rigtig interessant ift. optimering af ens egen træning.
...
{% include video id="3GdtnP8VJt4" provider="youtube" %}

{% include video id="XGRHkItKJPc" provider="youtube" %}
