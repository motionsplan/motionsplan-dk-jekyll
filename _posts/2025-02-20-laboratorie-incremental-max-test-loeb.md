...
description: Progressiv test med stigende intensitet og måling af aerob, anaerob og VO2peak med denne direkte test af iltoptagelse
  på løbebånd med maske.
language: da
header:
...
4. Pulsen skal være omkring den teoretiske maxpuls. Jeg har lavet en beregner, hvor du kan lave en [udregning af den maksimale puls](/max-puls-beregner/).
