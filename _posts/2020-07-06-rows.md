...
language: da
header:
  overlay_image: /assets/images/unsplash/photo-1583454110551-21f2fa2afe61.jpg
...
- image_path: https://www.bodyman.dk/images/bbleatherstrapsnature.png
  alt: Lifting til brug for bent over rows og andre row øvelser
  title: Lifting Straps
  excerpt: Lifting Straps som du kan bruge til [bent over rows](/oevelse/bent-over-rows-bor/), one arm rows
    og andre row varianter. De er også meget velegnede til dødløft.
  url: https://www.partner-ads.com/dk/klikbanner.php?partnerid=28187&bannerid=11522&htmlurl=https://www.bodylab.dk/shop/lifting-straps-4922p.html
...
- question: Hvad træner rows?
  answer: Hvilke muskler rows træner afhænger af hvilken variant, du bruger. Typisk rammer row-variationer den brede rygmuskel,
    øvre ryg, bagskulder og armbøjerne, fx biceps. Hvis du har albuerne tæt på kroppen, så rammer rows mere den brede rygmuskel,
    latissimus dorsi, og hvis du har albuerne ude, så rammer de lidt mere den øvre ryg. Hvis du har underhåndsgreb i row-variationerne,
    så er biceps lidt mere involveret, end hvis du bruger overhåndsgreb.
- question: Hvad er de bedste variationer af rows?
  answer: De mest brugte typer rows er formentlig bent over barbell rows med stang, one arm rows med håndvægte, siddende kabeltræk,
    Yates rows (med underhåndsgreb) og chest-supported rows på bænk.
---
