...
language: da
header:
  overlay_image: https://images.unsplash.com/photo-1526401485004-46910ecc8e51?ixlib=rb-1.2.1&auto=format&fit=crop&height=630&w=1200&q=10
  teaser: https://images.unsplash.com/photo-1526401485004-46910ecc8e51?ixlib=rb-1.2.1&auto=format&fit=crop&height=300&w=400&q=10
  caption: *title
...
Ud fra en maksimal test med fx 5 reps og en given vægt, kan du udregne dit maksimale 1RM-max løft. Du kan altså løfte lette vægte med mange gentagelser og stadig få et nogenlunde bud på, hvor stærk du er i øvelsen.
...
Den submaksimale estimering af 1RM-max kan være hurtigere og mere sikker særligt for uerfarne løftere end at lave 1RM-løft, men metoden er naturligvis ikke fejlfri.

En RM-beregnings kan både underestimere og overestimere den aktuelle 1RM for løfterne. Der er i hvert fald et par forhold, som man skal tænke på:
...
Du skal også have valgt den mest pålidelige algoritme til at bestemme 1RM max ud fra alle de forskellige formler, der findes.
...
Derfor kan RM-begrebet bruges til at estimere, hvad man netop kan løfte en gang. Når man udregner sin 1RM, så kan man nemlig konstruere et procentbaseret træningsprogram baseret på det man maksimalt kan løfte. I mange træningsprogrammer arbejder man med et lidt konservativt **træningsmax**, hvor man fx ganger en max med en faktor (fx 0,9). Derved sikrer man sig, at programmet ikke er for hårdt.
...
Jeg har skrevet et andet indlæg, der handler om, hvordan du [forbereder dig til en maxtest i styrketræning]({% link _posts/2020-11-29-pap-prepare-to-maxtest.md %}).
...
Jeg kan også rigtig godt selv lide at bruge [RPE-tabeller baseret på Rate of Perceived Exertion]({% link _posts/2019-08-10-rpe.md %}) til at estimere mine træningsvægte.

Bruger du en RM-udregner i din træning?
