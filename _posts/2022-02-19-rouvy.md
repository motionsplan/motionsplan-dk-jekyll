...
{% include motionsplan/affiliate-box.html type="category" item=site.data.affiliates.categories.hometrainers view="card" title="Mangler du udstyr til at køre på Rouvy?" text="Hvilken hometrainer eller smartbike skal du vælge? Læs vores [samlede udstyrsguide til indendørs cykling](/udstyr-hometrainer-ecykling/) for at se de bedste setups - eller tjek priser på disse links." %}
