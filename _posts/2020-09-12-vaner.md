...
language: da
header:
  overlay_image: /assets/images/unsplash/photo-1569230919100-d3fd5e1132f4.jpg
  credit: https://images.unsplash.com/photo-1569230919100-d3fd5e1132f4
  teaser: /assets/images/unsplash/photo-1569230919100-d3fd5e1132f4.jpg
  caption: 'Vaner: Hvordan kan du lave en livsstilsændring?'
category:
  - Psykologi
tags:
  - vaner
...
Et habit loop kan illustreres på denne måde. Der kommer et sanseindtryk, som giver dig en længsel. Du handler for at få en belønning.

{% include figure image_path="/assets/images/templatemonster.com/Habits-3-1024x433-1e138aa6.png" caption="Habit loop. Et _cue_ fører til en _craving_, som fører til et _response_ for at få en _reward_. Hvis du vil ændre en vane, så skal du sikre dig, at der er en belønning, som tilfredsstiller dig. Kilde: [modernhealthmonk.com](https://modernhealthmonk.com/why-all-diets-fail-habits-101/) [📷](https://www.templatemonster.com/blog/wp-content/uploads/2016/12/Habits-3-1024x433.png){: rel='nofollow noopener' }" %}
...
Hvis handlingen ikke skaber en belønning, så vil man typisk ikke gentage handlingen. Alle fire ting skal altså være til stede for, at man kan tale om en vane.
...
{% include figure image_path="/assets/images/jamesclear.com/tiny-gains-6905f1fb.jpg" caption="Kilde: [jamesclear.com](https://jamesclear.com/habit-guide) [📷](https://jamesclear.com/wp-content/uploads/2014/07/tiny-gains.jpg){: rel='nofollow noopener' }" %}
...
Det betyder, at hvis du gerne vil i bedre form, spise sundere, spise flere grøntsager, læse mere, motionere mere, arbejde mindre, løbe mere, eller hvad du ellers gerne vil implementere i din hverdag, så skal du altså følge de fire love for adfærdsændringer.
...
Når du har skrevet alle dine vaner ned, så har du et overblik over, hvilke vaner der er hensigtsmæssige for, at du kan nå dit mål, og hvilke vaner som står i vejen for dine mål.

#### 2️. 'Implementation intention'

Når du arbejder med [målsætninger](/smart/), vaneændringer og gerne vil starte en ny adfærd, så er er det lettere, hvis du er specifik.
...
Hvis du har besluttet dig for at få mere ro og pauser i løbet af en dag, så kan du 'bundle' pauser af en bestemt længde fx sammen med kaffen. Hvis du fx virkelig nyder at drikke kaffe, så bliver du også mindet om pausen, når du får lyst til kaffen.
...
Kort sagt skal du altså omgive dig mennesker og opsøge steder, hvor din ønskede adfærd er normen. Det gør det meget lettere at gøre adfærden til en vane.
...
Hvis du kan få vanerne til at passe ind i dagligdagen, så gør du det meget lettere at opretholde vanen. Fx drikker jeg et stort glas vand samtidig med at jeg tager en fiskeolietablet om morgenen. Jeg forsøger at lægge træningen lige før eller efter middagsmaden, hvor jeg alligevel har brug for en pause i mit arbejde.
...
Prøv fx at overveje følgende [eksempler foreslået af Søren Eltong](https://www.instagram.com/p/CE3qCI1hHTT/) på Instagram i sin gennemgang af Atomic Habits:
...
Mange bruger fx også et skridtur til at tælle dagens skridt. For mange er målet [10.000 skridt, selvom de største sundhedseffekter formentlig allerede træder i kraft ved 7.500 skridt](/skridt-pr-km-10000/). Det giver en umiddelbar tilfredsstillelse for de fleste at kunne se, at man har opnået målet med at bevæge sig, og det får du automatisk målt med et skridtur.
...
En let måde både at gøre en vane synlig, attraktiv og tilfredsstillende på, er ved at tracke den. James Clear foreslår, at du [bruger en habit tracker](https://jamesclear.com/habit-tracker), som kan være en enkel dagbog, som udformes som en tjekliste.
...
Hvis adfærden og tilfredsstillelsen skal kobles sammen, så er det vigtigt, at du laver overførslen med det samme.
...
Det er lykkedes mange gange for mig at gøre træning til en vane. Men jeg ved også nøjagtigt, hvornår jeg falder af vanen igen. Det gør jeg virkelig ofte, hvis jeg misser to træninger i træk.
...
{% include figure image_path="/assets/images/jamesclear.com/never-miss-twice-0d3faeb0.jpg" caption="Kilde: [jamesclear.com](https://jamesclear.com/habit-guide) [📷](https://jamesclear.com/wp-content/uploads/2014/07/never-miss-twice.jpg){: rel='nofollow noopener' }" %}
...
{% include figure image_path="https://images.unsplash.com/photo-1598301257942-e6bde1d2149b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=60" caption="Både _Atomic Habits_ af James Clear og _Thinking, fast and slow_ af Daniel Kahneman er fremragende bøger, som jeg kun kan anbefale at læse." %}
...
{% include motionsplan/affiliate-box.html type="product" item=site.data.affiliates.books.thinking_fast_and_slow view="card" %}
