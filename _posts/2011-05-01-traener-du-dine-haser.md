...
{% include motionsplan/exercise-grid.html exercises="Dødløft, Romanian" match="exact" type="left" %}

{% include motionsplan/exercise-grid.html exercises="Good morning" match="exact" type="left" %}
...
{% include motionsplan/exercise-grid.html exercises="Frivend, fra hang position" match="exact" type="left" %}

{% include motionsplan/exercise-grid.html exercises="Frivend, power fra blokke" match="exact" type="left" %}
...
{% include motionsplan/exercise-grid.html exercises="Reverse hyper" match="exact" type="left" %}

{% include motionsplan/exercise-grid.html exercises="Hofteudstrækning, et ben stående" match="exact" type="left" %}

### Træningspas 2: Øvelser til knæfleksion

**Øvelse 1.** Vi starter igen tungt med en af de bedste øvelser for baglårene.

{% include motionsplan/exercise-grid.html exercises="Glute ham raises" match="exact" type="left" %}
...
{% include motionsplan/exercise-grid.html exercises="Knæbøj" match="exact" type="left" %}
...
{% include motionsplan/exercise-grid.html exercises="Baglår, Nordic hamstring" match="exact" type="left" %}
