...
Programmet er målrettet den øvede løfter. Vi har samlet en [række andre træningsprogrammer til inspiration]({% link _pages/trainingprograms-styrke.md %}), hvis du vil have et program som er procentbaseret eller lidt mere enkelt i opbygningen.
