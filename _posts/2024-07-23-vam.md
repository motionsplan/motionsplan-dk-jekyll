...
tools:
  - id: "tool-vam-beregner"
    title: "VAM & Klatrehastighed Beregner"
    description: "Interaktiv beregner til udregning af din VAM (lodrette stigningsmeter i timen) og estimeret relativ power (watt/kg) ud fra stigningsprocent og tid."
    category: ["Cykling", "Beregnere"]
    type: ["Beregner"]
    measures: ["VAM", "Velocità Ascensionale Media", "Vertikal klatrehastighed", "Watt/kg", "Relativ power"]  # 🎯 Output-parametre fra beregneren
    anchor: "#beregner-til-vam"
