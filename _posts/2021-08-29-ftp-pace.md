...
permalink: /ftpa-loeb/
excerpt: FTPa står for Functional Threshold Pace. FTPa er den højeste gennemsnitlige hastighed en løber kan opretholde i en
  time. Til løb kan FTPa være et mål for kondition og den hastighed du kan opretholde i omkring 1 time. Derudover kan du bruge
  FTPa til at træningszoner, der kan bruges til din løbetræning.
language: da
header:
  overlay_image: /assets/images/unsplash/photo-1590333748338-d629e4564ad9.jpg
  credit: https://images.unsplash.com/photo-1590333748338-d629e4564ad9
  teaser: /assets/images/unsplash/photo-1590333748338-d629e4564ad9.jpg
  caption: 'FTPa: Functional Threshold Pace til løb'
categories:
- Løb
tags:
- beregner
...
# TESTS / PROTOKOLLER
tests:
  - id: "test-ftpa-20min-test"
    title: "FTPa 20-Minutters Løbetest"
    description: "20-minutters maksimal løbetest til indirekte bestemmelse af din Functional Threshold Pace (FTPa) og beregning af personlige træningszoner."
    category: ["Tests", "Kondition", "Løb"]
    type: ["Protokol", "Konditionstest"]
    execution: ["Fysisk"]                  # 🏃‍♂️ FYSISK TEST: Kræver 20 minutters all-out løbeindsats
    method: "indirekte"                   # ⏱️ Indirekte estimering af 60-minutters tærskelpace ud fra 20-minutters test
    modality: ["Løb"]
    measures: ["FTPa", "Løbehastighed", "Pace", "Anaerob tærskel"]
    equipment: ["Løbebane", "Løbebånd", "GPS-ur", "Pulsmåler"]
    setting: ["Udendørs", "Løbebane", "Løbebånd", "Individuel"]
    target_group: ["Motionister", "Atleter", "Løbere", "Mænd", "Kvinder"]
    related_tools:
      - "tool-ftpa-traeningszoner-beregner"

# INTERAKTIVE SOFTWARE-VÆRKTØJER
tools:
  - id: "tool-ftpa-traeningszoner-beregner"
    title: "FTPa Træningszoner Beregner"
    description: "Beregn dine personlige træningszoner (hastighed/pace) baseret på din testede Functional Threshold Pace (FTPa)."
    category: ["Løb", "Kondition"]
    type: ["Beregner"]
    measures: ["FTPa", "Træningszoner", "Pace-zoner", "Hastighedszoner"]  # 🎯 Output-parametre fra modulet
    anchor: "#calculator"
...
- question: Hvor ofte skal jeg tage en FTPa-test?
  answer: Når du træner, så flytter din FTPa sig. Det betyder, at det kan være en god ide at teste din FTPa hver 4.-6. uge,
    så du hele tiden bliver udfordret nok i dine løbetræningsprogrammer.
- question: Hvad er Functional Threshold Pace i forhold til Functional Threshold Power?
  answer: Threshold Pace er den hastighed du kan løbe med omkring din anaerobe tærskel. Threshold Power er den *power* - altså
    det arbejde - du kan levere med samme intensitet. Det måles i watt. Det er altså to mål, der begge relaterer sig til din
    laktatgrænse og den intensitet du kan arbejde med.
- question: Kan man bruge Functional Threshold Power (FTP) til løb?
  answer: 'Ja! For at bruge FTP til løb skal du imidlertid have et *device*, der kan måle hvor mange watt du løber med. [Stryd](https://buy.stryd.com/store?referrer_id=c444f8a6-8d83-59d2-7060-6e7eddbaf413){:
    rel=''sponsored nofollow noopener'' } har lavet en footpod, som ser ud til at være den mest præcise wattmåler til løb
    på markedet.'
---
...
Der findes forskellige måder at måle intensiteten i de enkelte træningspas. Vi har skrevet om [pulstræning](/pulstraening/) og [beregning af pulszoner](/pulszoner-beregner/). Du kan også køre på fornemmelsen ud fra fx [Borg-skalaen](/borg-skala/).
...
Vi har skrevet mere om de forskellige [træningszoner](/traeningszoner/) og [hvordan man laver et løbeprogram](/guide-til-loebeprogram/).
