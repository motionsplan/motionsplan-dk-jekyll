...
description: Lær om de mest anvendte retningsskift-tests (COD-tests) og forstå deres betydning for at vurdere og forbedre
  din agility.
excerpt: Lær om de mest anvendte retningsskift-tests (COD-tests) som 5-0-5, Illinois Agility Test og Arrow Head Testen. Forstå
  deres betydning for at vurdere og forbedre din agility.
