...
Du kan [udregne din VO<sub>2max</sub> fra følgende beregner](https://www.theyoyotest.com/calculator-yyir1.htm) for YYIR1. Formularen er baseret på følgende tabel, som findes på  [theyoyotest.com](https://www.theyoyotest.com/norms-yyir1.htm). For det mest præcise resultat, så skal du slå dit tal op i tabellen, da beregneren kan variere med 0,1 til 0,2 ml/kg/min i forhold til tabellen.
