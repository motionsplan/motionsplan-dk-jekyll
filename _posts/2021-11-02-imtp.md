...
* **Impuls (N·s):** Arealet under kraftkurven (fx de første 100 ms eller 200 ms). Nyere biomekanisk forskning fremhæver ofte impuls som et mere stabilt og pålideligt mål for eksplosivitet end ren RFD, fordi det er mindre følsomt for støj i data.
...
Her er et eksempel på et **forsøg, som ikke er gyldigt**:
...
Ovenstående test er usikker, fordi atleten bevæger sig inden start. Det lille dyk i kraftkurven lige før trækket (*countermovement dip*) aktiverer stræk-forkortnings-cyklussen (SSC). Det skaber et forspændings-artefakt, som gør både RFD og tidsmålinger ugyldige.
...
I stedet for at analysere kraftkurver manuelt i eksterne regneark, kan du trække din rå .acp- eller .acp2-fil direkte ind i analyseværktøjet herunder for øjeblikkelig beregning af alle nøgletal.
