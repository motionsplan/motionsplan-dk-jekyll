...
// Wallsticker
$xml = 'https://www.partner-ads.com/dk/feed_udlaes2.php?partnerid=28187&bannerid=53283&feedid=883';
$search = '';
$category = '';
...
foreach($xmldata->children() as $p) {        
    ...
    if (!empty($category) && strpos(strtolower($p->kategorinavn), $category) === false) {
        continue;
    }
